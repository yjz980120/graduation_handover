...
if __name__ == '__main__':
    ...
    #imgfile,swc_file,spacing = data_list[0]
    imgfile = "/home/yjz/Projects/Auto_tracing/neuronet/data/task002_allData/6235_5732_2862.npz"
    swc_file = "/home/yjz/Projects/Auto_tracing/neuronet/data/task002_allData/6235_5732_2862.swc"
    ...
    # random augmentation
    #import ipdb;ipdb.set_trace()
    img,tree,_ = augment(img,tree,spacing)
    ...
    #augment = InstanceAugmentation(p=0.2,imgshape=(128,160,160),phase="train")
    #import ipdb;ipdb.set_trace()
    ...
    if lab.max()<50:
        lab *= 255
    sitk.WriteImage(sitk.GetImageFromArray(np.squeeze(img).astype(np.uint8)),"img_ori.tiff")
    sitk.WriteImage(sitk.GetImageFromArray(np.squeeze(lab).astype(np.uint8)),"lab_ori.tiff")
