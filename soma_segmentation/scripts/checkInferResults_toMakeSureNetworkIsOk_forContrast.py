...
def check(infer_dir):
    ...
    num = 0
    for img_file in glob.glob(os.path.join(infer_dir,"*_test_img.tiff")):
        num += 1
        if num > 10:
            break
...
if __name__ == "__main__":
    ...
    inferForContrast_dir = "/home/yjz/Projects/Auto_tracing/neuronet/neuronet/exps/exp004/exp004_predict"
    check(inferForContrast_dir)
